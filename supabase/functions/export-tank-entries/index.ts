// Supabase Edge Function: export-tank-entries
//
// Baut aus allen Tankeinträgen aller Fahrer eine .xlsx-Datei — ein
// Arbeitsblatt je Kennzeichen und Monat ("Juli_GR400FX"). Jedes Blatt
// listet den Monat durchgehend Tag für Tag auf; gefüllt sind nur die Tage,
// an denen wirklich getankt wurde. Das ersetzt das händische Abtippen des
// Papierzettels und übernimmt Aufteilung und Aufbau der bisherigen
// Excel-Datei des Chefs.
//
// Warum hier und nicht als Vercel-API-Route: die Web-App wird mit
// `web.output: "static"` gebaut (app.json), es gibt also gar keine
// Server-Runtime auf Vercel und auch keine +api.ts-Routen — die setzen
// output: "server" voraus. Alle privilegierten Serveraufgaben dieses
// Projekts laufen bereits als Edge Function mit verifyBoss; das hier folgt
// dieser Konvention, statt nebenher ein zweites Deployment-Modell
// aufzumachen.
//
// Deploy: supabase functions deploy export-tank-entries
